...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addItems = function () {
        var _this = this;
        this.httpClient.get(this.API_URL + this.ENDPOINT + '?client_id=' + this.APPLICATION_ID + '&count=10').subscribe(function (res) {
            var images_res = [];
            Object.values(res).forEach(function (image) {
                images_res.push({ url: image.urls.regular, text: image.alt_description });
            });
            _this.images.push(images_res);
            _this.images = [].concat.apply([], tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.images));
        });
    };
